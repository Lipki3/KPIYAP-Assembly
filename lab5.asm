...
seekPos MACRO whatPos							; увеличивает позицию whatPos на cx
	local noCarry
...
checkTxt_OK:                                            
	...
	jc badSourse	        ; Если файл не открылся, то прыгаем в badSourse
...
writeDelims:                       
	...
	je notNewLine                       ; Если ax == 0 прыгаев в notNewLine
                                        ...
                                        ; Если перезодим на новую строку, то обнуляем индекс текущего слова                   
...
writeToFile PROC                      
	...
	mov bx, sourceID                  
	putPos PositionWrite			  ; устанавливаем положение курсора в файле
